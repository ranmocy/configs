...
install_homebrew() {
  ...
  ln -sfv $oh_my_configs_home/gitconfig ~/.gitconfig
  ln -sfv $oh_my_configs_home/gitexclude ~/.gitexclude
  ln -sfv $oh_my_configs_home/tmux.conf ~/.tmux.conf
}
...
confirm "Install RVM?" && install_rvm
